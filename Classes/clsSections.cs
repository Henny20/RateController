...
namespace RateController.Classes
{
    public class clsSections
    {
        ...
        public clsSections(MainWindow CallingForm)
        {
            mf = CallingForm;
        ...
        private async void AOG_SectionsChanged(object sender, EventArgs e)
        {
            double Wdth;
            string Units;
            if (mf.UseInches)
           ...
           // Hlp.ShowDialog();
            //bool Result = Hlp.Result;
             var messageBoxStandardWindow =
                MessageBoxManager.GetMessageBoxStandard(Message, "Section Changes");

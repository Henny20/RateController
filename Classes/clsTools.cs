...
namespace RateController
{
    public class clsTools
    {
       ...
       // private Form[] OpenForms = new Form[30];    // make sure to allocate enough ---nvt
...
*********/
        ...
        public Window IsViewOpen(string Name)
        {
           Window result = null;
           // Form Result = null;
         ...
         //   return Result;
           ...
           var wins = ((IClassicDesktopStyleApplicationLifetime)Application.Current.ApplicationLifetime).Windows;
        ...
        public bool IsOnScreen(Window form, bool PutOnScreen = false)
        {
        /*****
            // Create rectangle
        ...
        public void LoadFormData(Window Frm)
        {
        /********
            int Leftloc = 0;
        ...
        public void SaveFormData(Window Frm)
        {
        /********
            try
            {
        ...
        {
            var Hlp = new HelpView(mf, Message, Title, timeInMsec);
            if (Application.Current.ApplicationLifetime is IClassicDesktopStyleApplicationLifetime desktop)
			{
			    if (Modal)
		        {
		            Hlp.ShowDialog(desktop.MainWindow);
		        }
		        else
		        {
		            Hlp.Show();

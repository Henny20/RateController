...
namespace RateController.Classes
{
    public class clsSectionControl
    {
       ...
       // private System.Windows.Forms.Timer PrimeTimer = new System.Windows.Forms.Timer();
        private DispatcherTimer PrimeTimer = new DispatcherTimer();
        ...
        public clsSectionControl(MainWindow CallingForm)
        {
            mf = CallingForm;
            ...
            PrimeTimer.Interval = TimeSpan.FromMilliseconds(1000);
            PrimeTimer.IsEnabled = false;
        }

...
namespace RateController.Classes
{
    public class UDPComm
    {
        ...
        public UDPComm(MainWindow CallingForm, int ReceivePort, int SendToPort, int SendFromPort, string ConnectionName, string DestinationEndPoint = "")
        {
            mf = CallingForm;
        ...
        private void ReceiveData(IAsyncResult asyncResult)
        {
            try
            {
               ...
               // mf.Invoke(HandleDataDelegate, new object[] { port, localMsg }); TODO
            }
